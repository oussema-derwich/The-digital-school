    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600"><?php echo $employee['firstName'] . ' ' . $employee['lastName'] ?></span>
                <img class="img-profile rounded-circle" src="<?php echo $employee['profile_image'] ? $employee['profile_image'] : 'img/undraw_profile.svg'; ?>">
            </a>
